...
.NET Core 3.1 React Webpack App Template
...
Install the [simple-command-line-utilities-for-typescript](https://docs.servicestack.net/typescript-add-servicestack-reference#simple-command-line-utilities-for-typescript) to enable auto generating dtos later.
